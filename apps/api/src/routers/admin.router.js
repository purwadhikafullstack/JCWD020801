...
adminRouter.post('/safreshfinds', checkRegisterAdmin, superAdmin)
...
adminRouter.patch('/', verifyTokenAdmin, multerUploadProfile().single("image"), updateAdmin) //edit an admin
