        ...
        <Dialog size="sm" open={modalErrorOpen} className="px-3 pb-3 pt-5 flex flex-col items-center">
            ...
            <DialogFooter className="flex justify-end">
                <div className="flex justify-end gap-3">
                    <button onClick={() => setModalErrorOpen(false)} className="shadow-sm rounded-full px-5 py-2 border border-[#E5E7EB] text-[15px] font-medium text-gray-600 transition delay-100 ease-in-out hover:bg-gray-100">
                        Close
                    </button>
                </div>
            </DialogFooter>
