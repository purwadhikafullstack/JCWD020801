            ...
            <Dialog size="sm" open={modalOpen} className="px-3 pb-3 pt-5 flex flex-col items-center">
                ...
                <DialogFooter className="flex justify-end">
                    <div className="flex justify-end gap-3">
                        <button onClick={() => setModalOpen(false)} className="rounded-full bg-[#00a67c] px-6 py-2.5 text-[15px] font-semibold text-white transition delay-100 ease-in-out hover:bg-[#00916D] ">
                            Ok, got it!
                        </button>
                    </div>
                </DialogFooter>
