      ...
      <div className="flex flex-col gap-2 bg-white rounded-lg shadow-sm md:w-[17vw]">
        ...
        <div className='flex flex-col gap-2 p-5 -mt-4 h-full justify-between'>
          <div className='flex flex-col gap-1'>
            <p className="font-bold tracking-tight line-clamp-1 text-[#4eaf94] text-lg">
              {productData?.name}
            </p>
            ...
            <p className="leading-relaxed text-gray-700 text-[14px] md:text-[16px] line-clamp-1">
            ...
            <div className="flex flex-row gap-1 leading-relaxed text-gray-700">
              ...
              {productData?.SubCategory
                && <p className='leading-relaxed text-gray-700 text-[14px] md:text-[16px] line-clamp-1'>/ {productData?.SubCategory?.name}</p>
              }
            </div>
          </div>
