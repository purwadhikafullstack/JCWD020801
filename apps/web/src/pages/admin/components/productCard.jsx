        ...
        <>
            <div className="bg-white p-8 rounded-xl shadow-md">
                <div className="flex flex-col gap-2">
                    <img src={productImage ? productImage : 'https://th.bing.com/th/id/R.3156efdb345eadfa73224a6a32531124?rik=sFtdqrFD%2f60DrA&pid=ImgRaw&r=0&sres=1&sresct=1'} alt="product image" className="h-48 rounded-lg object-cover" />
                    ...
                    <div className="flex flex-row gap-1">
                        ...
                        <Typography>
                            Subcategory: {productData?.SubCategory ? productData?.SubCategory?.name : 'Empty'}
                        </Typography>
                    </div>
