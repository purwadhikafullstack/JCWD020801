...
export const ModalAccount = ({ isOpenAccount }) => {
    ...
    const renderAccountLinks = () => {
        if (customer.firstname) {
            ...
            const logOutLink = (
                <div onClick={() => setIsModalOpen(!isModalOpen)} className="border-t border-t-[#EEEEEE] cursor-pointer group border-l-2 border-white pb-1 pt-1.5 hover:border-l-[#3A826E] hover:bg-[#F0FAF7]">
            ...
            <AnimatePresence>
                {isOpenAccount && (
                    <motion.div
                        ...
                        className="bg-white z-50 w-[9rem] absolute top-[102px] rounded-lg pb-2 pt-1 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]"
                    >
