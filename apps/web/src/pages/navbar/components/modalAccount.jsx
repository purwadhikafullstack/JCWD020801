      ...
      return (
        <div className="">
          <div
            ...
            className="px-4 w-full cursor-pointer group border-l-2 border-white py-1 hover:border-[#3A826E] hover:bg-[#F0FAF7]"
          >
            <span className="whitespace-nowrap text-[15px] font-medium text-gray-600 group-hover:text-[#3A826E]">
              Sign in
            </span>
        ...
        {isOpenAccount && (
          ...
          >
            <div className="flex flex-col gap-0.5">
              <div className="px-4 font-semibold text-[15px] text-[#343538] py-1.5 border-b border-gray-200">
                Account
              </div>
              {renderAccountLinks()}
            </div>
