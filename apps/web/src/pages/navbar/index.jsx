      ...
      <div className="flex items-center justify-between border-b border-[#E4E4E4] px-[16px] py-2.5 lg:px-[160px]">
        ...
        <div className="flex items-center gap-[1rem]">
          ...
          <img
            src={appLogoSm}
            alt=""
            className="block h-[35px] md:hidden"
          ></img>
          ...
          <div className="ml-3 rounded-lg md:ml-0">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                id="table-search"
                className="block rounded-full border border-[#F6F7F8] bg-[#F6F7F8] p-2.5 pl-10 text-sm text-gray-900 transition-colors  duration-300 focus:border-blue-500 focus:outline-none focus:ring-blue-500 lg:w-[45vw]"
